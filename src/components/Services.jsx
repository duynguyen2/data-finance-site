...
const Services = () => {
    const servicesData = [
        ...
        },
        {
            ...
            description: 'We help you create a strong marketing strategies that drives results',
            icon: assets.ads_icon
        },
        {
            title: 'Social Media',
    ...
    return (
        <div id='services' className='relative flex flex-col items-center gap-6 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
